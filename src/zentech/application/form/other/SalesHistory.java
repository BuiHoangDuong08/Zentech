...
import controller.SalesHistoryController;
...
public class SalesHistory extends javax.swing.JPanel {
    ...
    List<SalesHistorymodel> salesHistoryList = shDao.getAllSalesHistory();

    public SalesHistory() {
        initComponents();
        controller = new SalesHistoryController(jTable2);
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/zentech/menu/icon/11.png"))); // NOI18N
    ...
    private void jTable2AncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_jTable2AncestorAdded
        ...
        controller.loadSalesHistoryToTable(jTable2);
...
String billIdText = jTextField1.getText();
controller.searchByBillId(billIdText, jTable2);
