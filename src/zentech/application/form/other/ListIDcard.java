...
public class ListIDcard extends javax.swing.JPanel {
    ...
    public ListIDcard() {
        ...
        addHint(jTextField3, "Input ID");
    }

    public void addHint(JTextField field, String hint) {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "waiting", "In use" }));
